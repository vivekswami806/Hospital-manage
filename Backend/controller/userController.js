...
export const login = catchAsyncErrors(async (req, res, next) => {
  ...
  console.log("---email, password, confirmPassword, role |", email, password, confirmPassword, role );
...
export const addNewAdmin = catchAsyncErrors(async (req, res, next) => {
  ...
  console.log("---- firstName, lastName, email, phone, password, gender, aadhar, dob|",  firstName, lastName, email, phone, password, gender, aadhar, dob);
